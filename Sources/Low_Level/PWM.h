...
\file       PWM.h
\brief      Pulse Width Modulator definitions and function prototypes.
...
#define PWM_PRESCALER   0x05    /* Bus Clock/64 */   
#define PWM_LEFT_ALIGN      0
#define PWM_CENTER_ALIGN    1
#define PWM_PERIOD          0xFF    /* PWM Period */
 
/*-- Function Prototypes -----------------------------------------------------*/

/** PWM Module initalization */
